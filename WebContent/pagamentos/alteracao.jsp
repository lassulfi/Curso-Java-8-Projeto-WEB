						...
						<div class="form-group">
							<div class="col-sm-3">
								<label for="inputDATA" class="control-label">Informar a
									DATA DE INSCRIÇ‡ÃƒO:</label>
							</div>
							<div class="col-sm-9">
								<input type="date" name="datainscricao" class="form-control"
									id="inputDATA" title="Preencha o campo DATA DE INSCRIÇÃO" required>
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-3">
								<label for="inputDATA" class="control-label">Informar a
									NOVA DATA DE INSCRIÇ‡ÃƒO:</label>
							</div>
							<div class="col-sm-9">
								<input type="date" name="novadata" class="form-control"
									id="inputDATA" title="Preencha o campo NOVA DATA DE INSCRIÇÃO" required>
							</div>
						</div>
